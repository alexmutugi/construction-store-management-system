                        ...
                        <form  method="POST" action='{{url("/Admin/save/material")}}'>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="number" class="col-sm-12 form-control" id="unit" required placeholder="Enter units (e.g tonnes, pieces)" name="unit">
                                    </div>
                                </div>
                        ...
                        @if(count($materials)>0)
                            ...
                            @foreach($materials as $material)
                                <tr>
                                    ...
                                    <td>
                                        <a href='{{url("material/delete/{$material->id}" )}}' class="text-warning" onclick="return confirm('please confirm delete, proceed??')"><i class="fa fa-fw fa-trash"></i> Delete</a>
                                    </td>
                                        @endif
