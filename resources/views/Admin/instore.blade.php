                        ...
                        <tr>
                            ...
                            @foreach($currents as $current)
                                <tr>
                                    ...
                                    <td>{{$current->material_category->category}}</td>
                                    <td>{{$current->name}}</td>
                                    <td>{{$current->current}} units </td>
                                </tr>
                            @endforeach
                ...
                <div class="list-group" style="margin-top: 10px;">
                    ...
                    @if(count($Tmaterials)>0)
                        @foreach($Tmaterials as $Tmaterial)
                            @if(Auth::User()->id <=2)
                            <a href='{{url("/view/{$Tmaterial->id}/materialType")}}'  class="list-group-item">{{$Tmaterial->name}}</a>
                            @else
                            <a href='{{url("keeper/view/{$Tmaterial->id}/materialType")}}'  class="list-group-item">{{$Tmaterial->name}}</a>
                            @endif
                        @endforeach
                    @else
